...
// Q.2 Find the maximum element of an array.
// Q.3 Find the second maximum element of an array.
// Q.4 Reverse an array, Eg:- [1,2,3] -> [3,2,1]
// Q.5 Segregate 0s and 1s and moves all 0's to start of the array. / Segregate 0s and 1s and moves all 0's to end of the array.
// Q.6 Find the min and max element in the array.
// Q.7 Given an array, rotate the array by one position in clock-wise direction. E.g:- [1, 2, 3, 4, 5] -> [5, 1, 2, 3, 4]
// Q.8 Rotate array by k element. E.g:- [1, 2, 3, 4, 5] k = 2 -> [3, 4, 5, 1, 2]
...
function rotateArrayByKOptimize(arr, k) {
